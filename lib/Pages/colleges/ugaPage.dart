...
class ugaPage extends StatefulWidget {
  @override
  _ugaPageState createState() => _ugaPageState();
}

class _ugaPageState extends State<ugaPage> {
  final htmlData = r"""
  <h2> First-year students are required to live in campus residence halls if they are enrolled as full-time students. Here is a link with some information about residence halls and living on campus: https://housing.uga.edu/register/?nav=is#incomingfirst </h2>
    """;
